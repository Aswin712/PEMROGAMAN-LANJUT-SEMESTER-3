...
class Project {
    ...
    public String projectDeadlines;
    public Employee projectLeader;
    public double budget;

    public Project(String projectName, String projectDeadlines, Employee projectLeader, double budget) {
    ...
    public void printProjectDetails() {
        ...
        System.out.println("Project Deadlines: " + projectDeadlines);
